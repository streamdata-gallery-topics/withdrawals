...
created: "2018-08-28"
modified: "2018-08-28"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/withdrawals/master/_listings/square/apis.md
...
- name: Square Connect - Provides summary information for all deposits and withdrawals
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/withdrawals/master/_listings/square/v1location-idsettlements-get-openapi.md
x-common:
- type: x-website
  url: http://square.com
- type: x-api-gallery
